...
LIBRI_PATH = os.path.join(KALDI_ROOT, 'egs/librispeech/s5/fmllr_cmvn/') # this needs to be generated by kaldi scripts
OUTPUT_DIR = './libri_fmllr_cmvn' # 

SETS = ['dev_clean', 'test_clean', 'train_clean_100', 'train_clean_360'] # you should not need to change this
...
def main():
    ...
    for s in SETS:
        with ReadHelper('ark:' + LIBRI_PATH + s + '/fmllr_cmvn.ark') as reader:
